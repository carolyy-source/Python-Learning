<script setup>
import { ref } from "vue";
import logo from "../assets/WanTrip logo-02.svg";
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center h-16">
        ...
        <div class="hidden md:flex items-center space-x-8">
          ...
          <div
            class="flex items-center space-x-4 border-l pl-6 border-gray-200"
          >
            ...
            <button
              class="bg-primary text-white px-4 py-2 rounded-md font-medium hover:bg-primary-hover transition-colors"
            >
              註冊
            </button>
          </div>
