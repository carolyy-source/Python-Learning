  ...
  <div class="min-h-screen bg-gray-50 flex flex-col">
    ...
    <main v-else class="flex-grow">
      ...
      <div class="relative h-[400px]">
        ...
        <div class="absolute inset-0 bg-black bg-opacity-40 flex flex-col justify-end pb-12 px-4 sm:px-6 lg:px-8">
          <div class="max-w-7xl mx-auto w-full">
            <h1 class="text-4xl font-bold text-white mb-2">{{ hotel.name }}</h1>
            <div class="flex items-center text-white space-x-4">
              <span class="bg-blue-600 px-2 py-1 rounded text-sm font-bold">{{ hotel.rating }} / 5</span>
              <span class="flex items-center">
                <svg class="w-5 h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13 21.314l-4.657-4.657a8 8 0 0111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div class="lg:col-span-2 space-y-12">
            ...
            <section>
              ...
              <div class="mt-8">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                  <div v-for="facility in hotel.facilities" :key="facility.id" class="flex items-center text-gray-600">
            ...
            <section>
              ...
              <div class="space-y-6">
                <div v-for="room in hotel.rooms" :key="room.id" class="bg-white border border-gray-200 rounded-lg p-6 flex flex-col sm:flex-row justify-between items-center hover:shadow-md transition-shadow">
                  ...
                  <div class="text-center sm:text-right">
                    <div class="text-2xl font-bold text-primary mb-2">TWD {{ room.base_price }}</div>
                    <button class="bg-primary text-white px-6 py-2 rounded-md font-medium hover:bg-blue-600 transition-colors w-full sm:w-auto">
                      選擇房間
                    </button>
                  </div>
                </div>
              ...
              <div class="space-y-6">
                <div v-if="hotel.policy">
                  ...
                  <div class="bg-green-50 text-green-800 p-3 rounded-md text-sm">
                    <p class="font-bold">{{ hotel.policy.cancellation_name }}</p>
                    <p>{{ hotel.policy.cancellation_description }}</p>
                  </div>
                </div>

                <div>
                  <h4 class="font-medium text-gray-900 mb-2">入住 / 退房時間</h4>
